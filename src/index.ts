...
import careTeamRoutes from './interfaces/http/routes/careTeamRoutes';
import clinicRoutes from './interfaces/http/routes/clinicRoutes';
...
import dailyReportRoutes from './interfaces/http/routes/dailyReportRoutes';
import voiceNoteRoutes from './interfaces/http/routes/voiceNoteRoutes';
...
import sharedNoteRoutes from './interfaces/http/routes/sharedNoteRoutes';
